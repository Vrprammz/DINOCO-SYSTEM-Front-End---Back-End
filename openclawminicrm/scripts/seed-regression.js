...
const SCENARIOS = [
  ...
  // Rule §3.1
  {
    ...
    assertions: {
      // แคบลง — จับเฉพาะ "ตัวไหนคะ/ตัวไหนครับ" (AI ถามกลับ) ไม่ใช่ "ตัวไหนก็ได้" (AI ตอบว่า)
      forbidden_patterns: [
        { pattern: "ตัวไหน\\s*(คะ|ครับ|หรอ|เหรอ|กัน|ดี|เป็น)|รุ่น\\s*ไหน\\s*(คะ|ครับ|หรอ|ดี)|สินค้า.*อะไร.*(คะ|ครับ)|ช่วย\\s*ระบุ", flags: "i", reason: "ห้ามถามกลับว่าตัวไหน/รุ่นไหน" },
      ],
      required_patterns: [
        { pattern: "กันล้ม|adv\\s*350|ติดตั้ง|ติดเอง|ช่าง|ประกอบ|น็อต|ศูนย์", flags: "i", reason: "ต้องอ้างอิง ADV350 หรือการติดตั้ง" },
      ],
    },
    retry_on_flaky: 1,
  },
