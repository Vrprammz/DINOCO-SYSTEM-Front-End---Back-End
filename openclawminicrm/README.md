...
[Demo](https://ai.dinoco.in.th/dashboard) · [คู่มือ](https://ai.dinoco.in.th/dashboard/guide) · [ห้องน้องกุ้ง 3D](https://ai.dinoco.in.th/dashboard/kung-room) · [แจ้งปัญหา](https://github.com/smlsoft/openclawminicrm/issues)
...
- **เอกสาร** --- AI จำแนกอัตโนมัติ (บัญชี/เอกสาร/ภาพ) + confidence score
- **Churn Prediction** --- เตือนลูกค้าเสี่ยงหาย 3/7/30 วัน
- **Broadcast** --- ส่งข้อความหลายคน แยก segment
- **Catalog สินค้า** --- ราคา สต็อก รูปภาพ หมวดหมู่
- **Revenue Dashboard** --- ยอดขายรายวัน/เดือน กราฟเทรนด์
- **Telegram Bot** --- ถาม AI ได้ตลอด ไม่ต้องเปิดคอม
- **Responsive** --- Mobile / Tablet / Desktop
- **A/B Testing AI** --- ทดสอบสไตล์ AI ตอบลูกค้า
- **Smart Routing** --- แยก topic อัตโนมัติ (sales/shipping/support)
...
| หน้า | หน้าที่ |
|------|---------|
| แชท (Multi-Panel) | เปิด 4 จอพร้อมกัน LINE/FB/IG + AI แนะนำ |
| Inbox | แชทจอเดียว + ข้อมูลลูกค้าด้านขวา |
...
| เงินเข้า | ตรวจสลิป ยืนยัน/ปฏิเสธ |
| เอกสาร | AI จำแนกเอกสาร/ภาพ |
| นัดหมาย | ปฏิทินนัด + แจ้งเตือน |
| สินค้า | แค็ตตาล็อก ราคา สต็อก |
| Broadcast | ส่งข้อความหลายคน |
...
ดูคู่มือเต็ม: [docs/DEPLOY-DIGITALOCEAN.md](docs/DEPLOY-DIGITALOCEAN.md)
...
[ai.dinoco.in.th](https://ai.dinoco.in.th) · [GitHub](https://github.com/smlsoft/openclawminicrm)
