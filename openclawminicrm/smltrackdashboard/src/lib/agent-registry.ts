...
export const AGENT_REGISTRY: Record<string, AgentInfo> = {
  ...
  "sales-hunter": {
    ...
    role: "Sales Hunter",
    category: "advisor",
    description: "สแกนโอกาสขายจากข้อมูลลูกค้า",
  },
  "team-coach": {
    name: "โค้ชทีม",
    ...
    role: "Team Coach",
    category: "advisor",
    description: "แนะนำทีมขายเรื่อง skill + เทคนิค",
  },
  "weekly-strategist": {
    name: "วางกลยุทธ์",
    emoji: "\u{1F4CB}",
  ...
  "upsell-crosssell": {
    name: "แนะนำสินค้าเพิ่ม",
    emoji: "\u{1F3AF}",
    color: "#c084fc",
    role: "Upsell",
    category: "advisor",
    description: "วิเคราะห์โอกาส upsell/cross-sell",
  },
  "daily-report": {
    name: "สรุปรายวัน",
    emoji: "\u{1F4CA}",
    ...
    role: "Daily Report",
    category: "advisor",
    description: "สรุปยอดขาย + กิจกรรมรายวัน",
  },
  "lead-scorer": {
    name: "ให้คะแนน Lead",
    emoji: "\u{1F3C6}",
