...
- **ห้าม:** พูดถึงมือจับเมื่อแนะนำ Side Rack
- **Context:** Bot ตอบ "กล่องข้าง Pro ที่ไม่ต้องถอดมือจับ" — ผิด
- **File:** `shared.js` line 55-59
- **Date:** 2026-04-07
...
- **ห้าม:** "พี่", "น้อง", "ดิฉัน", "ยินดีให้บริการ", "รับใช้"
- **Context:** ลูกค้าบอก "ดิฉัน ไม่มีใครเค้าใช้กัน"
...
- **File:** `shared.js` CONTEXT AWARENESS section
...
- **ถ้าลูกค้าถามซื้อจำนวนเยอะ:** แนะนำเปิดตัวแทนจำหน่าย
- **File:** `shared.js`
