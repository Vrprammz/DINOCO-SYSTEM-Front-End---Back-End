...
• "กล่อง 3 ใบ" / "full set" = Full Set: แร็คหลัง+แร็คข้าง+กล่องหลัง45L+กล่องข้าง37Lx2
  ...
  → ถ้าลูกค้าบอก "ตัวแต่งจากศูนย์" / "ตัวแต่งศูนย์" → ถือว่าเป็น DINOCO Edition เลย → แนะนำเพิ่มแค่กล่องข้าง + Side Rack **สีเงินเท่านั้น** (มีแร็คหลัง+กล่องหลังมาแล้ว ห้ามแนะนำ Pro Rack Full ซ้ำ)
