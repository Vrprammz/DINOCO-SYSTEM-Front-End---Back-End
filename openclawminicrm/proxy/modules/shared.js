...
=== ★★★ กฎ INTENT DETECTION ★★★ ===
• ลูกค้าถามร้าน/ตัวแทน/ซื้อที่ไหน/ติดที่ไหน → เรียก dinoco_dealer_lookup ทันที (ส่งจังหวัดถ้ามี) + ถ้าลูกค้าคุยสินค้ามาก่อน → เรียก dinoco_lead_create ด้วย (สร้าง lead ติดตามปิดการขาย)
