...
• "กล่อง 3 ใบ" / "full set" = Full Set: แร็คหลัง+แร็คข้าง+กล่องหลัง45L+กล่องข้าง37Lx2
  ...
  → ★ NX500 DINOCO Edition (ตัวแต่งจากศูนย์) = มีแร็คหลัง PRO มาแล้ว → แนะนำเพิ่มแค่กล่องข้าง PRO ไม่ต้องซื้อ Full Set
  → ถ้าลูกค้าบอก "ตัวแต่งจากศูนย์" / "มีแร็คท้ายจากศูนย์" / "Edition" → เป็น DINOCO Edition ต้องใช้ PRO เท่านั้น
