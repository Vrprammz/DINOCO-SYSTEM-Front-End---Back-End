...
• "กล่อง 3 ใบ" / "full set" = Full Set: แร็คหลัง+แร็คข้าง+กล่องหลัง45L+กล่องข้าง37Lx2
  ...
  → ★ ตัวแต่งออกศูนย์ NX500 มี 2 แบบ ต้องถามลูกค้าว่าเป็นแบบไหน:
    1. DINOCO Edition = มีแร็คหลัง PRO + กันล้ม + กล่องหลัง 45L + การ์ดแฮนด์ มาแล้ว → เพิ่มแค่กล่องข้าง PRO ได้เลย
    2. H2C Edition = ใช้ร่วมกับสินค้า DINOCO ไม่ได้เลย → แจ้งลูกค้าว่าไม่รองรับ
  → ถ้าลูกค้าบอก "ตัวแต่งจากศูนย์" → ถามว่า "เป็น DINOCO Edition หรือ H2C Edition คะ"
  → ถ้าบอก "ตัวแต่ง DINOCO" / "DINOCO Edition" → แนะนำเพิ่มกล่องข้าง PRO
  → ถ้าบอก "H2C" → แจ้งว่าไม่รองรับ
...
• ห้ามเอ่ยชื่อแบรนด์คู่แข่ง/H2C — ตอบจุดเด่น DINOCO แทน
