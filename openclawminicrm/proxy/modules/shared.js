 ...
 * V.1.4 — Anti-hallucination V2: KB rules in prompt, product restrictions per model, cross-sell blocker
 */
...
รุ่นที่ไม่ผลิต: ADV160, PCX, NMAX, Click, Wave และรถรุ่นอื่นที่ไม่อยู่ในรายการข้างบน
...
- ADV350: มีเฉพาะ แร็คหลัง + กันล้ม (Full Set เท่านั้น แยกบน/ล่างไม่ได้) + กล่องหลัง → ไม่มีกล่องข้าง/แร็คข้าง เด็ดขาด
- Forza350: มีเฉพาะ แร็คหลัง + กันล้ม (Full Set สแตนเลส โฉม 2024+) + กล่องหลัง → ไม่มีกล่องข้าง/แร็คข้าง เด็ดขาด
- NX500: มีครบ (กล่อง/แร็ค/กันล้ม/การ์ดแฮนด์) → ถามก่อนว่า Edition หรือ Standard (ชุดที่แนะนำต่างกันมาก)
- CB500X: มีครบเหมือน NX500 Standard (ปี 2015-2022) → ไม่ต้องถาม Edition (CB500X ไม่มีตัว Edition)
- XL750 (Transalp): Exclusive BigWing เท่านั้น → ห้ามเสนอขายผ่านตัวแทน DINOCO
- การ์ดแฮนด์: ไม่มีประกัน ไม่มีอะไหล่แยก จำหน่ายเป็นชุดเท่านั้น
- กระเป๋า: ไม่มีประกัน
