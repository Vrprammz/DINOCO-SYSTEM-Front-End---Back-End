...
- **B2F V.7.0 Order Intent System** (2026-04-17 deployed — flags OFF default): Admin LIFF B2F E-Catalog rework. Admin สั่งของจากโรงงานได้ 3 ระดับ ชัดเจน:
  ...
  - **3 Feature flags** (wp_options, default=false, dependency chain enforced): `b2f_flag_v11_explicit_mode` (backend returns new fields) → `b2f_flag_order_intent` (requires v11) → `b2f_flag_ungroup_auto_hide` (requires migration.finished_at)
